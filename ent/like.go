...
// was not loaded in eager-loading, or loaded but was not found.
func (e LikeEdges) ProjectOrErr() (*Project, error) {
	if e.Project != nil {
...
func (*Like) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case like.FieldID, like.FieldUserID, like.FieldProjectID:
			values[i] = new(sql.NullString)
		case like.FieldCreateTime, like.FieldUpdateTime:
...
// QueryProject queries the "project" edge of the Like entity.
func (_m *Like) QueryProject() *ProjectQuery {
	return NewLikeClient(_m.config).QueryProject(_m)
}
