...
func (_u *LikeUpdate) SetUpdateTime(v time.Time) *LikeUpdate {
...
func (_u *LikeUpdate) SetProjectID(v string) *LikeUpdate {
	_u.mutation.SetProjectID(v)
	return _u
}

// SetNillableProjectID sets the "project_id" field if the given value is not nil.
func (_u *LikeUpdate) SetNillableProjectID(v *string) *LikeUpdate {
	if v != nil {
		_u.SetProjectID(*v)
	}
	return _u
...
func (_u *LikeUpdate) SetProject(v *Project) *LikeUpdate {
...
func (_u *LikeUpdate) ClearProject() *LikeUpdate {
...
func (_u *LikeUpdate) check() error {
	...
	if _u.mutation.ProjectCleared() && len(_u.mutation.ProjectIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Like.project"`)
	}
	return nil
}
...
// SetUpdateTime sets the "update_time" field.
func (_u *LikeUpdateOne) SetUpdateTime(v time.Time) *LikeUpdateOne {
	_u.mutation.SetUpdateTime(v)
	return _u
}
...
// SetProjectID sets the "project_id" field.
func (_u *LikeUpdateOne) SetProjectID(v string) *LikeUpdateOne {
	_u.mutation.SetProjectID(v)
	return _u
}

// SetNillableProjectID sets the "project_id" field if the given value is not nil.
func (_u *LikeUpdateOne) SetNillableProjectID(v *string) *LikeUpdateOne {
	if v != nil {
		_u.SetProjectID(*v)
	}
	return _u
...
// SetProject sets the "project" edge to the Project entity.
func (_u *LikeUpdateOne) SetProject(v *Project) *LikeUpdateOne {
	return _u.SetProjectID(v.ID)
}
...
// ClearProject clears the "project" edge to the Project entity.
func (_u *LikeUpdateOne) ClearProject() *LikeUpdateOne {
	_u.mutation.ClearProject()
	return _u
}
